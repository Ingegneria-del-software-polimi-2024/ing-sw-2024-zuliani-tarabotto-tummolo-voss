...
//////////////////////// GETTER METHODS FOR GAMESTATE ATTRIBUTES ///////////////////////////
    ...
    /**
     * if the turn player disconnects before choosing the starter card face, the face side is automatically played
     *
     * @param player the disconnected player
     */
    ...
    /**
     * if the turn player disconnects and has palced a card but still has to draw, he will draw from the first available deck,
    ...
    /**
     * if the turn player disconnects and has not palced a card yet, the turn passes to the next player
     *
     * @param player the disconnected player
     */
