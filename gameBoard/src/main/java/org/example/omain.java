...
public class omain {
    public static void main(String[] args) {
        ...
        //gp2.setLayout(new BoxLayout(gp2, BoxLayout.Y_AXIS));
        ...
        bottomPanel.add(gp2, BorderLayout.CENTER);

        // Add the four sub-panels to the main panel
        mainPanel.add(topPanel, BorderLayout.NORTH);
        mainPanel.add(middlePanel, BorderLayout.CENTER);
        mainPanel.add(gp2, BorderLayout.SOUTH);
        ...
        // Create the pieces panel and add it to the right panel
        //PiecesPanel piecesPanel = new PiecesPanel(gp);
        // rightPanel.setLayout(new BorderLayout());
        // rightPanel.add(piecesPanel, BorderLayout.CENTER);
