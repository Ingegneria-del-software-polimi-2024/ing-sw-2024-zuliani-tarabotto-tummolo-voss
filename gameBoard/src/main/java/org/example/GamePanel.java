...
public class GamePanel extends JPanel implements Runnable {
    ...
    public void setPieces() {
        pieces.add(new ResourceCard(WHITE, 1, 6));
        pieces.add(new ResourceCard(WHITE, 7, 6));
        pieces.add(new ResourceCard(WHITE, 14, 6));
        pieces.add(new ResourceCard(WHITE, 21, 6));
